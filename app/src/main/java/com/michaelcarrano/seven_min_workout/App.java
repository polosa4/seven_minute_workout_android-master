...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        final String[] workoutNamesTwo = resources.getStringArray(R.array.workout_names_shoulders);
        ...
        if (WorkoutContentTwo.WORKOUTSTWO.isEmpty()) {
            for (int i = 0; i < workoutNamesTwo.length; i++) {
                WorkoutContentTwo.addWorkout(
                        new WorkoutContentTwo.WorkoutTwo(
                                String.valueOf(i + 1),
                                workoutNamesTwo[i],
                                workoutDescriptions[i],
                                workoutVideos[i],
